...
"""
function master_2D_experiment(integrators, num_repeats, V, D, T, sigma, stepsizes, xmin, ymin, xmax, ymax, n_bins, save_dir; chunk_size=10000000, x0=nothing, noise_integrator=nothing, n=nothing)
    to = TimerOutput()
