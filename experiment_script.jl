...
# Experiment 1 ---------------------------------------------------------------
# exp_name = "quartic_cos_noise_MT2_1M"     # Name
...
# # Experiment 2 ---------------------------------------------------------------
# exp_name = "quartic_cos_noise_W2Ito1_1M"     # Name
# save_dir = "$(master_dir)/$(exp_name)"
# integrators = [eugen_gilles1D]
...
# # Experiment 3 ---------------------------------------------------------------
# exp_name = "quartic_cos_noise_LMVD_n=5_1M"     # Name
# save_dir = "$(master_dir)/$(exp_name)"
...
# # Experiment 4 ---------------------------------------------------------------
# exp_name = "quartic_cos_noise_LMVD_n=2_1M"     # Name
# save_dir = "$(master_dir)/$(exp_name)"
# integrators = [limit_method_with_variable_diffusion1D]
# n = 2
