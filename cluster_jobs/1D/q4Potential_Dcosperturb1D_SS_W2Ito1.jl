...
import .Integrators: eugen_gilles1D, euler_maruyama1D, hummer_leimkuhler_matthews1D, leimkuhler_matthews1D, leimkuhler_matthews_markovian1D, limit_method_with_variable_diffusion1D, euler_maruyama2D, eugen_gilles2D, strang_splitting1D
...
n = nothing
integrators = [strang_splitting1D]

# EXPERIMENT NAME
exp_name = "q4Potential_Dcosperturb1D_SS_W2Ito1"
